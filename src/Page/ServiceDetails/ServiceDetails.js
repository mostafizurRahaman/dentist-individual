      ...
      <div>
         ...
         <section className="grid grid-cols-1 md:grid-cols-2 justify-center gap-10 px-12 mt-5 ">
            <div className=" p-2 bg-blue-500 rounded-2xl flex flex-col">
               ...
               <div>
                  <h2 className="text-4xl text-center bg-black py-2 text-white rounded-2xl mt-2">
                     {service}
                  </h2>
               </div>
            </div>
         ...
         <section>
            {user?.uid ? (
               ...
               <div className="my-10  flex items-center justify-center animate-bounce hover:animate-none ">
                  <Link
                     className="bg-blue-500 text-white px-3 py-2 rounded-xl hover:bg-orange-600 duration-1000"
                     to="/login"
                  >
                     {" "}
                     <h4 className="text-2xl">
                        For writing a review , Please Login
                     </h4>
                  </Link>
               </div>
            )}
