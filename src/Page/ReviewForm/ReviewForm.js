...
const ReviewForm = ({ singleService, reviews, setReviews }) => {
   ...
   const handleSubmit = (e) => {
      ...
      fetch("https://mr-dentist-server.vercel.app/reviews", {
         method: "POST",
         headers: {
         ...
         .then((data) => {
            if (data.acknowledged) {
               Swal.fire("Thank You!", "For give your feedback!", "success");
               const totalReviews = [
                  ...reviews,
                  {
                     email,
   ...
   return (
      <div className="flex items-center flex-col mb-10">
         <h2 className="text-3xl text-blue-500 before:w-1/2 before:h-1 before:inline-block pb-3  before:absolute inline-block relative before:bottom-0 before:bg-blue-500 text-center my-16  mt-10 ">
            Add A Review
         </h2>
         <form
