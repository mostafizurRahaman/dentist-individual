      ...
      <div>
         ...
         <div>
            <div className="flex items-center flex-col">
               <h2 className="text-3xl text-blue-500 before:w-1/2 before:h-1 before:inline-block pb-3  before:absolute inline-block relative before:bottom-0 before:bg-blue-500 text-center my-5  ">
                  Add An Service Now:{" "}
               </h2>
               <form
               ...
               >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                     <div className="flex flex-col w-full">
                        <label className="text-xl mb-2" htmlFor="service">
                           {" "}
                           Service Name:{" "}
                        </label>
                        <input
                        ...
                        />
                        {error.service && (
                           <ErrorMessage> {error.service} </ErrorMessage>
                        )}
                     </div>
                     <div className="flex flex-col w-full">
                     ...
                     <div className="flex flex-col w-full">
                        ...
                        />
                        {error.ratings && (
                           <ErrorMessage> {error.ratings} </ErrorMessage>
                        )}
                     </div>
                  ...
                  <button
                     className="block px-5 text-center text-xl text-white rounded-lg py-2 bg-orange-600 mx-auto submitButton hover:bg-black "
                     type="submit"
                  >
                     Post{" "}
                  </button>
