      ...
      <div>
         ...
         <div>
             ...
             <div className='flex items-center flex-col'>
               ...
               <form className='p-5 w-4/5 lg:w-2/5 rounded-2xl bg-blue-300  gap-5 flex flex-col' style={{ boxShadow: "6px 6px 6px inset rgba(0, 0, 255, 0.3, -6px -6px 6px inset rgba(0, 0, 255, 0.3))"}}>
