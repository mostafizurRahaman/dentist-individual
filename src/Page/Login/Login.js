...
const Login = () => {
   ...
   return (
      <div className="py-5  w-full registrationBg">
         ...
         >
            <div
               className="p-5 w-4/5 lg:w-2/5 rounded-2xl bg-blue-300 "
            ...
            >
               ...
               >
                  ...
                  <button
                     className="block px-5 text-center text-xl text-white rounded-lg py-2 bg-orange-600 mx-auto  hover:bg-black  "
                     type="submit"
                  >
                     Login
                  </button>
