...
const Header = () => {
   ...
   return (
      <div className="flex  items-center justify-between px-12 text-white h-20 w-full sticky z-10 top-0 left-0 bg-orange-600 ">
         <Link to="/" className="flex items-center justify-center gap-2">
            <img src={logo} alt="dentist" className="w-14 h-14 " />
            <h2 className="text-3xl font-bold uppercase">Mr. Dentist</h2>
         </Link>
         <div className={`flex absolute flex-col  md:static md:flex-row items-center gap-5 font-medium text-xl  py-5 md:py-0 w-full h-screen md:w-auto top-20 transition-all md:transition-none duration-1000  bg-gray-800 md:bg-transparent md:bg-opacity-100 z-30 bg-opacity-80  ${display ? 'left-0' : 'left-[-999px]' }`}>
