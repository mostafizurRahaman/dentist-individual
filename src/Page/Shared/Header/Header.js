...
const Header = () => {
   ...
   return (
      <div className="flex  items-center justify-between px-12 text-white h-20 w-full relative top-0 left-0 bg-orange-600 ">
         ...
         <div className={`flex absolute flex-col  md:static md:flex-row items-center gap-5 font-medium text-xl  py-5 md:py-0 w-full h-screen md:w-auto top-20 transition-all md:transition-none duration-1000  bg-gray-800 md:bg-transparent md:bg-opacity-100 z-30 bg-opacity-80  ${display ? 'right-0' : 'goleft' }`}>
