...
const Register = () => {
   ...
   return (
      <div className="py-5  w-full registrationBg">
         ...
         >
            <div
               className="p-5 w-4/5 lg:w-3/5 rounded-2xl bg-blue-300 "
            ...
            >
               ...
               >
                  ...
                  <button
                     className={`block px-5 text-center text-xl text-white rounded-lg py-2 bg-orange-600 mx-auto  ${
                        isDisabled ||
                        " hover:bg-black bg-opacity-80 pointer-events-none"
                     }`}
                     type="submit"
                     disabled={!isDisabled}
                  >
               ...
               <div className="flex items-center justify-center text-center text-sm mt-5  gap-5">
                  <button
                     className="flex items-center justify-center flex-col gap-1  px-5 py-2 bg-white rounded-lg text-red-500"
